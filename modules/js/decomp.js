!(function (e) {
  "object" === typeof exports
    ...
    ? (global.decomp = e())
    : "undefined" !== typeof self && (self.decomp = e());
})(function () {
      ...
      3: [
        function (require, module, exports) {
          ...
          Polygon.prototype.canSee = function (a, b) {
            ...
            if (
              Point.leftOn(this.at(a + 1), this.at(a), this.at(b)) &&
              Point.rightOn(this.at(a - 1), this.at(a), this.at(b))
            ) {
              return false;
            }
            ...
            for (var i = 0; i !== this.vertices.length; ++i) {
              ...
              if ((i + 1) % this.vertices.length === a || i === a)
                ...
                continue;
              if (
                Point.leftOn(this.at(a), this.at(b), this.at(i + 1)) &&
                Point.rightOn(this.at(a), this.at(b), this.at(i))
              ) {
          ...
          Polygon.prototype.quickDecomp = function (
            ...
            for (var i = 0; i < this.vertices.length; ++i) {
              if (poly.isReflex(i)) {
                ...
                for (var j = 0; j < this.vertices.length; ++j) {
                  if (
                    Point.left(poly.at(i - 1), poly.at(i), poly.at(j)) &&
                  ...
                  if (
                    Point.left(poly.at(i + 1), poly.at(i), poly.at(j + 1)) &&
                ...
                if (lowerIndex === (upperIndex + 1) % this.vertices.length) {
                  ...
                  for (var j = lowerIndex; j <= upperIndex; ++j) {
                    if (
                      Point.leftOn(poly.at(i - 1), poly.at(i), poly.at(j)) &&
                      Point.rightOn(poly.at(i + 1), poly.at(i), poly.at(j))
                    ) {
